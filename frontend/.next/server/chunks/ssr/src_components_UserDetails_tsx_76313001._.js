...
function UserDetailsPage() {
    ...
    const { user, setUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleLogout = async ()=>{
        const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/user/logout`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
//# sourceMappingURL=src_components_UserDetails_tsx_76313001._.js.map